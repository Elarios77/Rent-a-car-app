...
fun MainScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        )
        {
            ...
            {
                InfoCard(
                    title = stringResource(R.string.About_header),
                    content = stringResource(R.string.About_body)
                )
                Spacer(modifier = Modifier.padding(20.dp))
                InfoCard(
                    title = stringResource(R.string.vision_header),
                    content = stringResource(R.string.vision_body)
                )
                Spacer(modifier = Modifier.padding(20.dp))
                Text(
                    text = stringResource(R.string.why_to_choose),
                    fontSize = 20.sp,
                    fontWeight = FontWeight.ExtraBold,
                ...
                FeatureRow(
                    ...
                    title = stringResource(R.string.features1_title),
                    body = stringResource(R.string.features1_body)
                )
                FeatureRow(
                    icon = Icons.Default.Schedule,
                    title = stringResource(R.string.features2_title),
                    body = stringResource(R.string.features2_body)
                )
                FeatureRow(
                    icon = Icons.Default.SupportAgent,
                    title = stringResource(R.string.features3_title),
                    body = stringResource(R.string.features3_body)
                )
                ...
                Card(
                    ...
                    Column(
                        ...
                        ContactRow(
                            ...
                            text = stringResource(R.string.email_flexdrive)
                        )
                        ContactRow(
